    ...
    <>
      ...
      <div className="mx-auto max-w-prose select-none">
        <div className="space-y-2 pt-12 p-6 md:space-y-5">
          ...
          <img src="https://images.unsplash.com/photo-1577909659949-2302826adf26?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Rochelle Wang Profile" className="rounded-full w-1/2 mx-auto md:w-2/5  md:mx-0"/>
